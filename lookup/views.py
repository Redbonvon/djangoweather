...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=8286E30D-CFF8-4DAC-9E12-676EA77B31A4")
        try:
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=8286E30D-CFF8-4DAC-9E12-676EA77B31A4")
    try:
        api = json.loads(api_request.content)
    except Exception as e:
        api = "Error..."
