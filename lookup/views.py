...
def home(request):
    ...
    import json
    import requests
    api_requests = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=8286E30D-CFF8-4DAC-9E12-676EA77B31A4")
    try:
